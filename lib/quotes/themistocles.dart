...
const List<String> themistoclesQuotes = [
...
final QuotesData themistocles = new QuotesData(
    'Themistocles',
    'c. 524 BC',
    '459 BC',
    themistoclesQuotes,
    'https://upload.wikimedia.org/wikipedia/commons/8/86/Illustrerad_Verldshistoria_band_I_Ill_116.png',
    themistoclesBio);
